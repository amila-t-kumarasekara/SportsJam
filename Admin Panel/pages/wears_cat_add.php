                ...
                <div class="py-2">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                            ...
                            <li class="breadcrumb-item"><a href="wears_add.php">Wears</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Wears Category</li>
                        </ol>
                    </nav>
                    <div class="d-flex justify-content-between w-100 flex-wrap">
                        <div class="mb-3 mb-lg-0">
                            <h1 class="h4">Wears Category</h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-md-center">
                    <div class="card border-light shadow-sm components-section">
                        <div class="main-panel">
                            <form method="POST" name="catForm" action="insert_update_delete.php" onsubmit="return myFunction()" enctype="multipart/form-data">
                                <div class="form-group mb-4">
                                    <label for="exampleInputEmail1">Wears Category Add</label>
                                    <div class="cateInput">
                                        <input type="text" class="form-control" id="category" name="category" aria-describedby="emailHelp" placeholder="Enter Wears Category">
                                    </div>
                                </div>
                                <div class="mb-4">
                                    <button type="submit" id="wears_category_add" name="wears_category_add" class="cateBtn btn btn-primary">Submit</button>
                                </div>
                            </form>
                            <div class="mb-4">
                                <h1 class="h4">Wears Category Table</h1>
                            </div>
                            <div class="card card-body border-light shadow-sm table-wrapper table-responsive pt-3">
                                <form action="category_view.php" method="post">
                                    <table class="table table-hover">
                                        ...
                                        <?php
                                        include 'wears_category_view.php';
                                        ?>
                                        </tbody>
                                    </table>
                                </form>
                    ...
                    <script>
                        function myFunction() {
                            let name = document.forms["catForm"]["category"].value;
                            if (name == ''){
