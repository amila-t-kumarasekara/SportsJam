                ...
                <div class="py-2">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Wears Sub Category</li>
                        </ol>
                    </nav>
                    <div class="d-flex justify-content-between w-100 flex-wrap">
                        <div class="mb-3 mb-lg-0">
                            <h1 class="h4">Wears Sub Category</h1>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="main-panel">
                            <form method="POST" name="subcatForm" action="insert_update_delete.php" onsubmit="return myFunction()" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Wears Sub Category Add</label>
                                    <div class="mb-4 cateInput">
                                        <input type="text" class="form-control" id="subcategory" name="subcategory" aria-describedby="emailHelp" placeholder="Enter Wears Sub Category">
                                    </div>
                                </div>
                                <div class="mb-4">
                                    <button type="submit" id="wears_subcate_Add" name="wears_subcate_Add" class="cateBtn btn btn-primary">Submit</button>
                                </div>
                            </form>
                            <div class="mb-4">
                                <h1 class="h4">Wears Sub Category Table</h1>
                            </div>
                            <div class="card card-body border-light shadow-sm table-wrapper table-responsive pt-3">
                                <table class="table table-hover">
                                    ...
                                    <?php
                                    include 'wears_sub_cate_view.php';
                                    ?>
                                    </tbody>
                                </table>
                            </div>
