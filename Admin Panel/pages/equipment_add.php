                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link pt-1 px-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <div class="media d-flex align-items-center">
                                            <img class="user-avatar md-avatar rounded-circle" alt="Image placeholder" src= "../assets/img/team/profile-picture-4.jpg">
                        ...
                        <form method="POST"  name="subcatForm" action="insert_update_delete.php" onsubmit="return myFunction()"  enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <select class="form-select" name="category_list" aria-label="Default select example">
                                    ...
                                    <button type="submit" class="mr-9 mt-2 cateBtn btn btn-primary" href="category_add.php"><a href="category_add.php" class="cateBtn">New Category</a></button>
                                </div>
                            </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="d-flex justify-content-between w-100 flex-wrap">
                                    <div class="select_cat_list mb-3 mb-lg-0 mt-2">
                                        <select class="form-select" name="sub_cat_list" aria-label="Default select example">
                                            <?php
                                            include 'sub_category_list_view.php';
                                            ?>
                                        </select>
                                    </div>
                                    <button type="submit" class="mr-9 mt-2 cateBtn btn btn-primary" href="sub_cate_add.php"><a href="sub_cate_add.php" class="cateBtn">New Sub Category</a></button>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="equ_input form-control" name="equName" aria-describedby="emailHelp" placeholder="Equipment Name">
                                </div>
                            </div>

                            <div class="mb-4">
                                <label for="email">Equipment Description</label>
                                <div class="d-flex justify-content-between flex-wrap w-50">
                                    <input type="text" class="equ_input form-control" name="equDesc" aria-describedby="emailHelp" placeholder="Equipment Description">
                                </div>
                            </div>

                            <div class="mb-4">
                                <label for="email">Equipment Image</label>
                            <div class="form-file w-50">
                                <div class="input-group mb-3">
                                    <input type="file" class="form-control" id="uploadImg" name="uploadImg" aria-describedby="inputGroupFileAddon03" aria-label="Upload">
                                </div>
                            ...
                            <div class="mb-4">
                                <label for="email">Equipment Quantity</label>
                                <div class="d-flex justify-content-between flex-wrap w-50">
                                    <input type="text" class="equ_input form-control" name="equQty" aria-describedby="emailHelp" placeholder="Equipment Quantity">
                                </div>
                            </div>

                            <div class="mb-4">
                                <label for="email">Equipment Price</label>
                                <div class="d-flex justify-content-between flex-wrap w-50">
                                    <input type="text" class="equ_input form-control" name="equPrice" aria-describedby="emailHelp" placeholder="Equipment Price">
                                </div>
                            </div>

                            <div class="mb-4">
                                <button type="submit" id="equAdd" name="equAdd" class="cateBtn btn btn-primary">Submit</button>
                            </div>
                        </form>
                        <div class="mb-4">
