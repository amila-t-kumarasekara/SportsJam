                    ...
                    <div class="main-panel">
                        <form method="POST" name="catForm" action="insert_update_delete.php" onsubmit="return myFunction()" enctype="multipart/form-data">
                            <div class="form-group mb-4">
                                <label for="exampleInputEmail1">Category Add</label>
                                <div class="cateInput">
                                    <input type="text" class="form-control" id="category" name="category" aria-describedby="emailHelp" placeholder="Enter Category">
                                </div>
                            </div>
                            <div class="mb-4">
                            <button type="submit" id="category_add" name="category_add" class="cateBtn btn btn-primary">Submit</button>
                            </div>
                        </form>
                        <div class="mb-4">
                            <h1 class="h4">Category Table</h1>
                        </div>
